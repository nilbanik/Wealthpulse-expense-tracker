...
export const Navbar = ({
  ...
  return (
    <header className="sticky top-0 z-40 border-b border-[#172334] bg-[#05080c]/90 backdrop-blur-2xl">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          
          {/* Brand Logo & Tagline */}
          <div className="flex items-center space-x-3">
            <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-emerald-600 via-emerald-700 to-yellow-600/80 flex items-center justify-center shadow-lg shadow-emerald-950/60 ring-1 ring-emerald-400/30">
              <Vault className="w-5 h-5 text-emerald-100" />
            </div>
            <div>
              <div className="flex items-center space-x-2">
                <span className="text-lg font-extrabold tracking-tight font-display bg-clip-text text-transparent bg-gradient-to-r from-emerald-300 via-yellow-200 to-amber-400">
                  WEALTHPULSE
                </span>
                <span className="hidden sm:inline-block px-2 py-0.5 text-[9px] font-bold uppercase tracking-wider bg-emerald-500/10 text-emerald-400 border border-emerald-500/20 rounded">
                  Multi-Currency
                </span>
              </div>
              <p className="hidden md:block text-[10px] text-slate-500 uppercase tracking-widest font-semibold font-mono-num">
                Private Finance & Liquidity Terminal
              </p>
            </div>
          </div>

          {/* Month & Multi-Currency Switcher */}
          <div className="flex items-center space-x-2 sm:space-x-3">
            ...
            <div className="relative" ref={monthDropdownRef}>
              <button
                ...
                className={`flex items-center space-x-2 px-3 py-1.5 rounded-xl border transition-all duration-200 shadow-inner text-xs sm:text-sm font-semibold cursor-pointer ${
                  showMonthDropdown
              ...
              >
                ...
                <span className="font-display tracking-tight text-xs sm:text-sm">{currentMonthLabel}</span>
                <motion.div
            ...
            <div className="relative" ref={currencyDropdownRef}>
              <button
                ...
                className={`flex items-center space-x-2 px-3 py-1.5 rounded-xl border transition-all duration-200 shadow-inner text-xs font-semibold cursor-pointer ${
              ...
              >
                ...
                <div className="flex items-center space-x-1.5 leading-none">
                  <span className="px-1.5 py-0.5 rounded bg-yellow-500/15 text-yellow-400 font-mono-num font-extrabold text-[11px] border border-yellow-500/25 inline-flex items-center justify-center min-w-[20px] h-[18px]">
            ...
            <button
              ...
              className="hidden lg:flex items-center space-x-1.5 px-3 py-1.5 rounded-xl bg-[#0a0f16] hover:bg-[#121b27] border border-yellow-500/30 text-xs font-semibold text-yellow-400 transition-all duration-200 hover:border-yellow-500/60 shadow-sm cursor-pointer"
            >
          ...
          <div className="flex items-center space-x-2.5 sm:space-x-3">
            ...
            {/* User Profile & Logout */}
            <div className="flex items-center pl-2 sm:pl-3 border-l border-[#1e2d42] space-x-2">
              <button
                type="button"
              ...
              >
                <div className="hidden lg:flex flex-col text-right">
                  <span className="text-xs font-bold text-slate-200">{user?.name || 'Account'}</span>
                  <span className="text-[10px] text-slate-400 truncate max-w-[120px] font-mono-num">{user?.email}</span>
                </div>
